                ...
                <div class="card-body">
                    <div class="d-flex flex-wrap justify-content-between align-items-center">
                        ...
                        <div class="d-flex flex-wrap">
                            <a class="m-1" href="/task/create/{{ $categories->id }}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-plus" viewBox="0 0 16 16">
                                    <path d="M8 6.5a.5.5 0 0 1 .5.5v1.5H10a.5.5 0 0 1 0 1H8.5V11a.5.5 0 0 1-1 0V9.5H6a.5.5 0 0 1 0-1h1.5V7a.5.5 0 0 1 .5-.5z" />
                                    <path d="M14 4.5V14a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h5.5L14 4.5zm-3 0A1.5 1.5 0 0 1 9.5 3V1H4a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V4.5h-2z" />
                                </svg>
                            </a>
                            <a class="m-1" href="/category/delete/{{ $categories->id }}">
                    ...
                    @foreach($categories->tasks as $tasks)
                    <div class="card m-3 task">
                        ...
                        <div class="card-footer d-flex flex-wrap justify-content-start bg-white">
                            <form action="/task/update/category" method="post">
                                @csrf
                                <input type="hidden" name="prev" id="prev" value="{{$tasks->prev}}">
                        ...
                        @elseif($tasks->prev==null)
                        <div class="card-footer d-flex flex-wrap justify-content-end bg-white">
                            <form action="/task/update/category" method="post">
                                @csrf
                                <input type="hidden" name="next" id="next" value="{{$tasks->next}}">
                                <input type="hidden" name="id" id="id" value="{{$tasks->id}}">
                                <button type="submit" class="btn p-0">
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="staticBackdrop-{{$tasks->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title">{{ $categories->title }}</h5>
                                    <h2 class="modal-title" id="staticBackdropLabel">{{ $tasks->title }}</h2>
                                    <div class="d-flex flex-wrap align-items-center justify-content-center">
                                        <a href="/task/update/{{$tasks->id}}" class="p-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                                <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
                                                <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z" />
                                            </svg>
